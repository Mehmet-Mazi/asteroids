...
class MainSceneManager(SceneManager):
  ...
  def create_transition_mappings(self):
    self._transition_map = {
      "start_game": lambda **kwargs:setattr(self, "current_scene", GameScene(self, self._screen, kwargs)),
      "pause": lambda:setattr(self, "current_scene", PauseScene(self, self._screen)),
